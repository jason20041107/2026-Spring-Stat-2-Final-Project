...
This project uses the **YRBS 2007 Dataset**. The dataset includes survey responses from high school students about health behaviors, physical activity, BMI-related variables, and demographic information.
